...
int missionaries_cannibals_bfs(int missionaries, int cannibals, int &acc_node){
    ...
    //estado inicial: 
    bfs.push({missionaries,cannibals,0,0,0,0}); 
    ...
    while(!bfs.empty()){
        ...
        if (boat_pos == 0){
            ...
            if(!visited[right_shore_missionaries-2][right_shore_cannibals][left_shore_missionaries+2][left_shore_cannibals][1])
            {
                ...
                {
                    bfs.push({right_shore_missionaries-2, right_shore_cannibals, left_shore_missionaries+2, left_shore_cannibals, 1, steps+1});
            ...
            if(!visited[right_shore_missionaries][right_shore_cannibals-2][left_shore_missionaries][left_shore_cannibals+2][1]){
                ...
                {
                    bfs.push({right_shore_missionaries, right_shore_cannibals-2, left_shore_missionaries, left_shore_cannibals+2, 1, steps+1});
            ...
            if(!visited[right_shore_missionaries-1][right_shore_cannibals-1][left_shore_missionaries+1][left_shore_cannibals+1][1])
            {
                ...
                {
                    bfs.push({right_shore_missionaries-1, right_shore_cannibals-1, left_shore_missionaries+1, left_shore_cannibals+1, 1, steps+1});
            ...
            if(!visited[right_shore_missionaries-1][right_shore_cannibals][left_shore_missionaries+1][left_shore_cannibals][1])
            {
                ...
                {
                    bfs.push({right_shore_missionaries-1, right_shore_cannibals, left_shore_missionaries+1, left_shore_cannibals, 1, steps+1});
            ...
            if(!visited[right_shore_missionaries][right_shore_cannibals-1][left_shore_missionaries][left_shore_cannibals+1][1])
            {
                ...
                {
                    bfs.push({right_shore_missionaries, right_shore_cannibals-1, left_shore_missionaries, left_shore_cannibals+1, 1, steps+1});
        ...
        //>>>>>>>>>>> Else, the boat is at the left shore <<<<<<<<<<<<<
            ...
            if(!visited[right_shore_missionaries+2][right_shore_cannibals][left_shore_missionaries-2][left_shore_cannibals][0]){
                ...
                {
                    bfs.push({right_shore_missionaries+2, right_shore_cannibals, left_shore_missionaries-2, left_shore_cannibals, 0, steps+1});
            ...
            if(!visited[right_shore_missionaries][right_shore_cannibals+2][left_shore_missionaries][left_shore_cannibals-2][0]){
                ...
                {
                    bfs.push({right_shore_missionaries, right_shore_cannibals+2, left_shore_missionaries, left_shore_cannibals-2, 0, steps+1});
            ...
            if(!visited[right_shore_missionaries+1][right_shore_cannibals+1][left_shore_missionaries-1][left_shore_cannibals-1][0]){
                ...
                {
                    bfs.push({right_shore_missionaries+1, right_shore_cannibals+1, left_shore_missionaries-1, left_shore_cannibals-1, 0, steps+1});
            ...
            if(!visited[right_shore_missionaries+1][right_shore_cannibals][left_shore_missionaries-1][left_shore_cannibals][0])
            {
                ...
                {
                    bfs.push({right_shore_missionaries+1, right_shore_cannibals, left_shore_missionaries-1, left_shore_cannibals, 0, steps+1});
            ...
            if(!visited[right_shore_missionaries][right_shore_cannibals+1][left_shore_missionaries][left_shore_cannibals-1][0])
            {
                ...
                {
                    bfs.push({right_shore_missionaries, right_shore_cannibals+1, left_shore_missionaries, left_shore_cannibals-1, 0, steps+1});
